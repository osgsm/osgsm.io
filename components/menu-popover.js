    ...
    <Popover.Root>
      <Popover.Trigger
        className={clsx(
          ...
          'hover:bg-[var(--button-accent-background)] hover:text-[var(--button-accent-foreground)]',
          'focus-visible:bg-[var(--button-accent-background)] focus-visible:text-[var(--button-accent-foreground)] focus-visible:outline-none focus-visible:ring-offset-1'
        )}
      >
