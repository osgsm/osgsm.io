...
const Header = () => {
  return (
    <header className="sticky top-0 z-50 grid w-full place-items-center bg-gradient-to-b from-5% from-[--iris-1] to-50% px-4 py-3 lg:my-6">
      <div className="gradient-card flex w-full items-center justify-between gap-4 rounded-xl border border-iris-4 px-4 py-3 backdrop-blur-md [--gradient-from:var(--iris-a4)] [--gradient-to:var(--iris-a3)] [--shadow-accent-color:var(--iris-a4)] [--shadow-base-color:var(--iris-a2)] sm:w-fit dark:border-0 dark:backdrop-brightness-[0.2]">
