...
ちなみに、[GitHub CLIのすヽめ&オレオレ関数で効率化していく](https://zenn.dev/toraco/articles/d6b760fd11bf3a) で紹介されている次の関数を `.zshrc` に追加すると、プルリクエストの確認 → チェックアウトまでを行えるので便利です。筆者の方に感謝🙏🏻
